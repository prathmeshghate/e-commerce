namespace Entity.productDesc
{
    ...
    public class ProductDescription
    {
        ...
        public string Colour { get; set; } // L,R,G,B
        public string ImagePath { get; set; } // ecommerce/ui/abc.jpg,ecommerce/ui/abc.jpg
        public string Attribute1 { get; set; }
        public string Attribute1Value { get; set; } // L,R,G,B
